...
class DiretoriaController {
  ...
  static async removerUsuarios(req, res) {
    try {
      const diretoria = await diretoriaService.removerUsuarios(req.body);
  ...
  static async listarUsuarios(req, res) {
    try {
      const diretoria = await diretoriaService.listarUsuarios({id: req.params.id});
